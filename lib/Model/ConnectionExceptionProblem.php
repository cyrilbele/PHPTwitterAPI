...
class ConnectionExceptionProblem extends Problem 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ConnectionExceptionProblem';
    ...
    const CONNECTION_ISSUE_TOO_MANY_CONNECTIONS = 'TooManyConnections';
const CONNECTION_ISSUE_PROVISIONING_SUBSCRIPTION = 'ProvisioningSubscription';
const CONNECTION_ISSUE_RULE_CONFIGURATION_ISSUE = 'RuleConfigurationIssue';
const CONNECTION_ISSUE_RULES_INVALID_ISSUE = 'RulesInvalidIssue';
...
self::CONNECTION_ISSUE_RULES_INVALID_ISSUE,        ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['connection_issue'] = isset($data['connection_issue']) ? $data['connection_issue'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['connection_issue']) && !in_array($this->container['connection_issue'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'connection_issue', must be one of '%s'",
     ...
     *
     * @param string $connection_issue connection_issue
     *
     * @return $this
     */
