 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class UserWithheld implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'UserWithheld';
...
'scope' => 'getScope'    ];
     ...
     * Sets scope
     *
     * @param string $scope Indicates that the content being withheld is a `user`.
     *
     * @return $this
     */
